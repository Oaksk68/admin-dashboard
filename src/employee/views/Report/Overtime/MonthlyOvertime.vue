    ...
    <div class="bg-white rounded-tr-3xl rounded-b-3xl p-10 pb-5">
      <div class="flex gap-3 items-center pb-8">
        <div class="flex gap-4">
          ...
          <h1 class="text-primary text-3xl">ทำงานล่วงเวลารายเดือน</h1>
        </div>
      ...
      <div class="relative mb-7">
        <div class="md:flex justify-between">
          ...
          <div class="flex flex-col md:flex-row gap-2 items-center mt-2 md:mt-0">
            ...
            <div class="w-full flex justify-end gap-2">
              <div @click="
                $download(
                  'report/export-monthly-overtime',
                  'Monthly Overtime'
                )
                "
        ...
        <div class="container grid gap-2 md:flex mt-5">
          <div class="box-card py-5 md:w-1/2 text-center">
            <h1 class="text-primary text-lg mb-2">เฉลี่ยการทำงานล่วงเวลา</h1>
            <h1 class="text-3xl text-primary font-medium">{{ avgOT }}</h1>
          </div>
          <div class="box-card py-5 md:w-1/2 text-center">
...
export default {
  ...
  mounted() {
    this.$getEmployeePaginateReport("emp-monthly-ot-report", this.filter, true, 'monthlyOTs');
  },
};
</script>
