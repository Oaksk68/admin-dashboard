    ...
    <main class="px-4">
        ...
        <div class="bg-white rounded-tr-3xl rounded-b-3xl md:p-10 pb-5">
            <div class="flex justify-between items-center pb-8">
                <div class="flex gap-3 p-5 md:p-0">
                    <div class="inline-block h-8 w-1 bg-origin rounded-2xl"></div>
                    <h1 class="text-primary text-3xl">การเข้างานตรงเวลารายเดือน</h1>
                </div>
            </div>
            <div class="relative mb-7 px-10 md:px-0">
                <div class="md:flex justify-between">
                    <div class="grid gap-2 md:flex md:gap-4">
                        ...
                        <VueDatePicker model-value="filter.date" :format-locale="th" format="MMMM yyyy" month-picker>
                        </VueDatePicker>
                    </div>
                ...
                <div class="grid md:flex gap-3 mt-5">
                    <div class="box-card py-5 md:w-1/2 text-center">
                        ...
                        <h1 class="text-3xl text-primary font-medium">{{ avg_intime }}</h1>
                    </div>
                    <div class="box-card py-5 md:w-1/2 text-center">
            ...
            <div id="accordion" class="block md:hidden border-b mb-4">
                <div v-for="( data, index ) in  tableData " :key="index" class="border-t py-2 pl-5 pr-3" id="accordion">
                    <button @click="this.$toggleAccordion(index, 'monthlyInTimeAttendance')"
                        class="flex items-center w-full gap-3">
                        <font-awesome-icon :id="`monthlyInTimeAttendance-chevron-${index}`"
                            class="bg-origin p-2 text-white rounded-full" icon="fa-solid fa-chevron-up" rotation="180" />
