<template>
  <main class="w-full bg-calendarBg">
    ...
    <BaseModal class="pr-4" :isOpen="paymentHistory" :classList="'md:w-[70vw] w-full'" @close-modal="closeModal">
      <template #title>
      ...
      <template #container>
        <div class="grid md:flex gap-2 md:gap-4 w-full p-2">
          <div class="relative">
          ...
          <div class="md:w-1/4">
            <VueDatePicker :format="$format" v-model="date" :enable-time-picker="false" />
          </div>
      ...
      <template v-slot:footer>
        <div class="grid gap-2 justify-center md:flex md:justify-between">
    ...
    <!-- history popup -->
    <BaseModal :isOpen="details" :classList="'md:w-[70vw] w-full'" @close-modal="closeModal">
      <template #title>
        <div class="flex justify-between md:justify-center">
          <h1 class="text-start md:text-center font-medium text-3xl">รายละเอียด</h1>
          <div @click="
            editHistory = true;
          details = false;
          " :class="showEditBtn ? '' : 'hidden'"
            class="md:hidden relative w-12 h-12 shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] rounded-full transition-all duration-200 bg-chooser hover:bg-slate-200">
            <img class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" src="@/assets/images/edit.svg"
              alt="" />
          </div>
        </div>
        ...
        <div class=" bg-white rounded-lg">
          <div class="">
            <div class="justify-end hidden md:flex">
              ...
              details = false;
              " :class="showEditBtn ? '' : 'hidden'"
                class="relative shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)]  rounded-full transition-all duration-200 hover:bg-slate-200">
            ...
            <div class="container md:p-4">
              ...
              <div class="mt-3 md:mt-0 md:flex">
                <div class="md:w-1/3">
                  <h1 class="bg-calendarBg py-1 px-5">รายละเอียดการชำระเงิน</h1>
                </div>
                <div class="md:w-2/3 md:pl-8">
                  <div class="text-primary md:flex justify-between items-center">
                    <h1 class="py-2 font-medium">{{ $t('name') }}</h1>
      ...
      <template #footer>
        <div class="grid md:flex justify-items-center md:justify-around text-center mt-8 gap-4">
    ...
    <!-- editHistory popup -->
    <BaseModal :isOpen="editHistory" :classList="'md:w-[60vw] w-full'" @close-modal="closeModal">
      <template #title>
        <h1 class="text-start md:text-center font-medium text-3xl">รายละเอียด</h1>
      </template>
      <template #container>
        <div class="md:p-4 bg-white md:w-[90%] max-h-[50rem] overflow-y-auto rounded-lg" @click.stop="">
          <div class="container md:p-4">
            <div class="md:flex">
              <div class="md:w-1/3">
                <h1 class="bg-calendarBg py-1 px-5">รายละเอียดแพ็กเกจ</h1>
    ...
    <div class="">
      <div class="flex flex-wrap bg-white rounded-tr-3xl gap-4 rounded-b-3xl md:p-8 p-4">
        <!-- card -->
        <div v-for="(data, index) in apiData.packages" :key="'package' + index"
          ...
          <div class="flex justify-between items-center h-16">
            <div class="green flex justify-center items-center rounded-3xl w-24 h-10">
              <h5 class="font-normal text-sm text-primary">กำลังใช้งาน</h5>
            </div>
